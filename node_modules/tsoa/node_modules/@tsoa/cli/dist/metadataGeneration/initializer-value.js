...
exports.getInitializerValue = function (initializer, typeChecker, type) {
    ...
    switch (initializer.kind) {
        case ts.SyntaxKind.ArrayLiteralExpression:
            ...
            return arrayLiteral.elements.map(function (element) { return exports.getInitializerValue(element, typeChecker); });
        ...
        case ts.SyntaxKind.NewExpression:
            ...
            if (ident.text === 'Date') {
                ...
                if (newExpression.arguments) {
                    ...
                    var argsValue = newArguments.map(function (args) { return exports.getInitializerValue(args, typeChecker); });
...
var hasInitializer = function (node) { return node.hasOwnProperty('initializer'); };
