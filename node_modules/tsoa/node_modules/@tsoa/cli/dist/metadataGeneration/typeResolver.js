    ...
    TypeResolver.prototype.resolve = function () {
        ...
        if (ts.isIndexedAccessTypeNode(this.typeNode) &&
            ...
            try {
                ...
                throw new exceptions_1.GenerateMetadataError("Could not determine the keys on " + this.current.typeChecker.typeToString(this.current.typeChecker.getTypeFromTypeNode(this.current.typeChecker.typeToTypeNode(declaration))), this.typeNode);
            }
        }
